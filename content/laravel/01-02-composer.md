...
این درس، به معرفی کامپوزر و نقش آن به عنوان سیستم مدیریت بسته‌های پی‌اچ‌پی اختصاص دارد.
...
##### رسم است که پوشه‌ی vendor را از دسترس گیت دور نگاه می‌دارند (ایگنور می‌کنند) تا بتوانند میان محیط‌های توسعه و بهره‌برداری را با سهولت هرچه تمام‌تر تفاوت قائل شوند.
