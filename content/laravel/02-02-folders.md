...
این همان پوشه‌ای است که هنگام [نصب و راه‌اندازی لاراول](/laravel-0-to-60/chapter02/lesson01/install/) در لوکال‌هاست‌های متداولی همچون Xamp به زور در نشانی بالای مرور خود نشاندیم. 
...
پوشه‌ی resource، جای خوبی برای نگهداری تمام فایل‌های خام و کامپایل‌نشده‌ی مورد استفاده در سمت کاربر (فرانت)، مثل sassها و lessها نیز هست.
...
###### اگر با الگوهای PSR در زبان پی‌اچ‌پی آشنا نیستید، درس مستقلی را در فصل یکم به این موضوع اختصاص داده‌ایم. از دستش ندهید.
...
لاراول به صورت پیش‌فرض پوشه‌ای برای مدل‌ها در نظر نگرفته و آن‌ها را در کف پوشه‌ی app قرار می‌دهد که ظاهر ناخوش‌آیندی دارد. خوشبختانه این فریمورک به شما اجازه می‌دهد هر چیزی را هر جایی خواستید قرار دهید و بنابراین می‌توانید پوشه‌ای به نام Models در app بسازید کلاس‌ها را در آن تعریف کنید.
